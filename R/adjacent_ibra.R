...
#' @param type Character. Either \code{'polygon'}, \code{'region'} or 
#'   \code{'subregion'}. This determines how the IBRA polygons will be subset: 
#'   \code{'polygon'} disaggregates the IBRA7 multipolygons and returns the 
#'   subset of \code{ibra7_albers} that represents polygons containing points,
#'   or polygons adjacent to those containing points; \code{'region'} results in
